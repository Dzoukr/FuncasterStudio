...
var CONFIG = {
    ...
    indexHtmlTemplate: './src/FuncasterStudio.Client/index.html',
    fsharpEntry: './.fable-build/App.js',
    cssEntry: './src/FuncasterStudio.Client/styles/styles.css',
    outputDir: './publish/app/public',
    assetsDir: './src/FuncasterStudio.Client/public',
    devServerPort: 8080,
